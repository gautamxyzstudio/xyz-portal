...
const dependencies = {
  ...
  "@strapi/helper-plugin": "4.25.24",
  "@strapi/icons": "1.19.0",
  "@strapi/utils": "4.25.24",
  bcryptjs: "2.4.3",
  cheerio: "^1.0.0-rc.12",
  formik: "2.4.0",
  "fs-extra": "10.0.0",
...
const index = {
  register(app) {
    app.addMenuLink({
      ...
      async Component() {
        const component = await Promise.resolve().then(() => require("./index-RfcsaXCl.js"));
        return component;
      }
    });
    app.registerPlugin({
  ...
  bootstrap(app) {
    app.addSettingsLink("global", {
      ...
      async Component() {
        const component = await Promise.resolve().then(() => require("./index-BmAPBNqI.js"));
        return component;
      },
      permissions: PERMISSIONS.main
    });
...
//# sourceMappingURL=index-Zg4rWKeq.js.map
