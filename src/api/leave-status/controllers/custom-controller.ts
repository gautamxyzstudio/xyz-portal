    ...
    try {
      ...
      if (
        ...
        console.log('Debug - Current user data:', {
          ...
          currentBalance: currentUser?.leave_balance,
          currentUnpaidBalance: currentUser?.unpaid_leave_balance,
        });
        ...
        if (currentUser) {
          ...
          if (currentBalance >= leaveDays) {
            ...
            newBalance = 0;
            newUnpaidBalance = Math.max(
              0,
              currentUnpaidBalance - remainingDays
            );
          }
